...
app = FastAPI(title='Mayson Generated APIs - coll-a705b0f8c847408ca25fa2ebd9457285', debug=False,
              docs_url='/distracted-isha-e1528286945511f0af24b2a60573ee5a74/docs',
              openapi_url='/distracted-isha-e1528286945511f0af24b2a60573ee5a74/openapi.json',
              root_path='')
...
app.include_router(
    router,
    prefix='/distracted-isha-e1528286945511f0af24b2a60573ee5a74/api',
    tags=['APIs v1']
)
